...
/** Mois sélectionnables pour la tarification haute saison (1 = janvier … 12 = décembre). */
export const PEAK_SEASON_MONTH_OPTIONS = [
  { month: 1, label: 'Jan' },
  { month: 2, label: 'Fév' },
  { month: 3, label: 'Mar' },
  { month: 4, label: 'Avr' },
...
export function getMinStayNights(service: RoomRateFields): number {

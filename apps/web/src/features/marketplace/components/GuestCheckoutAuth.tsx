...
export function GuestCheckoutAuth() {
  ...
  return (
    <div className="mb-8 p-6 bg-brand-50/80 border border-brand-100 rounded-3xl">
      <div className="flex items-center gap-2 mb-3">
        <Smartphone size={18} className="text-brand-600" />
        <h2 className="font-extrabold text-slate-900">Continuer sans compte</h2>
      </div>
      <p className="text-sm text-slate-600 mb-4">
        Recevez un code par SMS pour valider votre commande — aucun mot de passe requis.
      </p>
      {step === 'phone' ? (

    ...
    <div className="bg-white border border-slate-200 p-6 rounded-[32px] shadow-xl shadow-slate-200/50">
      ...
      <div className="space-y-4 mb-6">
        <div className="grid grid-cols-2 gap-3">
          ...
          <label className="bg-slate-50 border border-slate-200 p-3 rounded-xl cursor-pointer hover:border-brand-300 transition-colors block">
        ...
        <label className="flex items-center justify-between bg-slate-50 border border-slate-200 p-3 rounded-xl cursor-pointer hover:border-brand-300 transition-colors">
          <div>

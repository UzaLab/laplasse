...
const STEPS = [
  { n: 1, label: 'Panier', href: '/cart' as const },
...
const styles = StyleSheet.create({
  ...
  circleActive: { backgroundColor: colors.slate900 },
  circleCurrent: { borderWidth: 2, borderColor: colors.brand500 },
  ...
  lineActive: { backgroundColor: colors.slate900 },
})
